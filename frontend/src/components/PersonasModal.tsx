    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] p-4">
      <div className="bg-white rounded-lg shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex justify-between items-center">
          <h2 className="text-2xl font-bold text-gray-900">Individual Persona Responses</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          {personas.map((persona, index) => (
            <div key={index} className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">{persona.perspective}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">{persona.reasoning}</p>
                </div>
